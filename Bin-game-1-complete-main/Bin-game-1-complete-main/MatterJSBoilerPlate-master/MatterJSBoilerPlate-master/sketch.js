...
var paper, bin, ground, b2, b3 ,binIm, bim2, bim3, roof, bim4, bim5;
...
function setup() {
	...
	ground = new Ground(400, 380, 800, 10);
	 ...
	 roof = createSprite(705, 275, 180, 10);
	  ...
	  bim4 = createSprite(745, 325, 10, 100);
	  bim4.shapeColor = "green";
	  bim5 = createSprite(665, 325, 10, 100);
	  bim5.shapeColor = "green";
	Engine.run(engine);
